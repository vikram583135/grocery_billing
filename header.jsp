   <!-- CSS Reset -->
        ...
        <!--<link rel="stylesheet" type="text/css" href="css/css/theme-red.css" media="screen" />-->
        <!--<link rel="stylesheet" type="text/css" href="css/css/theme-yellow.css" media="screen" />-->
        <!--<link rel="stylesheet" type="text/css" href="css/css/theme-green.css" media="screen" />-->
        <!--<link rel="stylesheet" type="text/css" href="css/css/theme-graphite.css" media="screen" />-->
...
<div id="header">
            ...
            <div id="header-status">
                <div class="container_12">
                    <div class="grid_8 style1">                      
						 <h1> <font color="#FFFFFF">GROCERY SYSTEM</font> </h1>
